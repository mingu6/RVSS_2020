...
def save_img(cv2_img, dataset_root, label):
    ...
    img_name = os.path.join(dir_path, '010_' + f'{file_count:06}' + '.png')
    cv2.imwrite(img_name, cv2_img)


if __name__ == '__main__':
    img_dir = '/home/ming/repos/RVSS_2020_Workshop/network/collected_data/train/crocodile'
    export_dir = '/home/ming/repos/RVSS_2020_Workshop/network/nn_dataset/train/crocodile'
